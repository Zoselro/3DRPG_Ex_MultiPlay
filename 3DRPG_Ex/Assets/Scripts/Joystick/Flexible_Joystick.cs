...
public class Flexible_Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    {  //JoystickPickPanel 이미지를 마우스를 드래그하는 동안 발생되는 이벤트 함수
        ...
        InputDirection = clampedPos / Js_Radius; //벡터의 최대 크기는 1.0f가 되도록 계산
...
}//public class Flexible_Joystick
